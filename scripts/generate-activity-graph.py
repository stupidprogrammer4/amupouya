...
OUTPUT = pathlib.Path(sys.argv[1]) if len(sys.argv) > 1 else ROOT / "static/images/activity-graph.svg"


def fetch_days() -> list[tuple[dt.date, int]]:
    url = f"https://github.com/users/{USERNAME}/contributions"
    request = urllib.request.Request(url, headers={"User-Agent": "amupouya-activity-graph/1.0"})
...
<defs>
  <linearGradient id="area" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#27ff73" stop-opacity=".34"/><stop offset="1" stop-color="#27ff73" stop-opacity="0"/></linearGradient>
